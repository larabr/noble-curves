...
declare abstract class BigInteger {
    private static Implementation;
    static setImplementation(Implementation: ConcreteBigInteger, replace?: boolean): void;
     ...
     * @param {BigInteger} x - Shift value
     */
    abstract irightShift(x: BigInteger): BigInteger;
    /**
     * Shift this to the right by x
     * @param {BigInteger} x - Shift value
     * @returns {BigInteger} this >> x.
     */
    abstract rightShift(x: BigInteger): BigInteger;
    /**
