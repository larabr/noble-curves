...
export declare function bytesToNumberBE(bytes: Uint8Array): BigInteger;
 ...
 */
export declare function bitLen(n: BigInteger): number;
/**
 * Gets single bit at position.
 * NOTE: first bit position is 0 (same as arrays)
 * Same as `!!+Array.from(n.toString(2)).reverse()[pos]`
 */
export declare const bitGet: (n: BigInteger, pos: number) => number;
/**
 ...
 */
export declare const bitMask: (n: number) => BigInteger;
...
declare const validatorFns: {
    readonly BigInteger: (val: any) => boolean;
