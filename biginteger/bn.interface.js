 ...
 * @private
 */
class BNBigInteger extends interface_js_1.default {
    /**
    ...
    constructor(n) {
        ...
        this.value = new bn_js_1.default(n); // Note: if n is a BN, this just returns the reference, no cloning
    }
    clone() {
     ...
     */
    iinc() {
        this.value.iadd(new bn_js_1.default(1));
        return this;
    }
    /**
     ...
     */
    idec() {
        this.value.isub(new bn_js_1.default(1));
        return this;
    }
    /**
    ...
    modExp(e, n) {
        ...
        const nred = n.isEven() ? bn_js_1.default.red(n.value) : bn_js_1.default.mont(n.value);
        const x = this.clone();
    ...
    isOne() {
        return this.value.eq(new bn_js_1.default(1));
    }
    isNegative() {
...
exports.default = BNBigInteger;
//# sourceMappingURL=bn.interface.js.map