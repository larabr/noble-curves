...
const ut = __importStar(require("./utils.js"));
const utils_js_1 = require("./utils.js");
const curve_js_1 = require("./curve.js");
const index_js_1 = require("../biginteger/index.js");
// Be friendly to bad ECMAScript parsers by not using bigint literals
// prettier-ignore
const _0n = Object.freeze(index_js_1.BigInteger.new(0));
const _1n = Object.freeze(index_js_1.BigInteger.new(1));
const _2n = Object.freeze(index_js_1.BigInteger.new(2));
const _3n = Object.freeze(index_js_1.BigInteger.new(3));
const _8n = Object.freeze(index_js_1.BigInteger.new(8));
...
function twistedEdwards(curveDef) {
    ...
    const MASK = _2n.leftShift(index_js_1.BigInteger.new(nByteLength * 8).idec());
    ...
    const inBig = (n) => n instanceof index_js_1.BigInteger && n.gt(_0n); // n in [1..]
    const inRange = (n, max) => inBig(n) && inBig(max) && n.lt(max); // n in [1..max-1]
    const in0MaskRange = (n) => n.isZero() || inRange(n, MASK); // n in [0..MASK-1]
    ...
    class Point {
        ...
        add(other) {
            ...
            if (a.equal(index_js_1.BigInteger.new(-1))) {
        ...
        toAffine(iz) {
            ...
            if (is0)
                return { x: _0n.clone(), y: _1n.clone() };
            if (!zz.isOne())
    ...
    Point.BASE = new Point(CURVE.Gx, CURVE.Gy, _1n, modP(CURVE.Gx.mul(CURVE.Gy)));
