...
function montgomery(curveDef) {
    ...
    const powPminus2 = CURVE.powPminus2 || ((x) => (0, modular_js_1.pow)(x, P.sub(_2n), P));
    ...
    */
    ...
    function assertFieldElement(n) {
        if (n instanceof index_js_1.BigInteger && !n.isNegative() && n.lt(P))
            return n;
    ...
    function montgomeryLadder(pointU, scalar) {
        ...
        let swap = _0n.clone();
        let sw;
        for (let t = index_js_1.BigInteger.new(montgomeryBits - 1); !t.isNegative(); t.idec()) {
            const k_t = index_js_1.BigInteger.new((k.rightShift(t)).getBit(0));
            swap.ixor(k_t);
