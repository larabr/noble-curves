...
const _4n = Object.freeze(index_js_1.BigInteger.new(4));
const _5n = Object.freeze(index_js_1.BigInteger.new(5));
const _8n = Object.freeze(index_js_1.BigInteger.new(8));
const _9n = Object.freeze(index_js_1.BigInteger.new(9));
const _16n = Object.freeze(index_js_1.BigInteger.new(16));
...
function tonelliShanks(P) {
    ...
    let Q = P.dec();
    let S = index_js_1.BigInteger.new(0);
    ...
    let Z = index_js_1.BigInteger.new(2);
    const Pminus1 = P.dec();
    ...
    return function tonelliSlow(Fp, n) {
        ...
        while (!Fp.eql(b, Fp.ONE)) {
            ...
            // Find m such b^(2^m)==1
            let m = index_js_1.BigInteger.new(1);
...
const isNegativeLE = (num, modulo) => (mod(num, modulo).getBit(0) === 1);
...
function FpDiv(f, lhs, rhs) {
    return f.mul(lhs, rhs instanceof index_js_1.BigInteger ? invert(rhs, f.ORDER) : f.inv(rhs));
}
exports.FpDiv = FpDiv;
...
function Field(ORDER, bitLen, isLE = false, redef = {}) {
    ...
    const f = Object.freeze({
        ...
        isValid: (num) => {
            if (!(num instanceof index_js_1.BigInteger))
