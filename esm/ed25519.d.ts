...
export declare const hashToCurve: (msg: Uint8Array, options?: htfBasicOpts | undefined) => import("./abstract/hash-to-curve.js").H2CPoint<BigInteger>;
export declare const encodeToCurve: (msg: Uint8Array, options?: htfBasicOpts | undefined) => import("./abstract/hash-to-curve.js").H2CPoint<BigInteger>;
...
declare class RistPoint {
    ...
    static fromAffine(ap: AffinePoint<BigInteger>): RistPoint;
    /**
