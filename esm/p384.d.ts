...
export declare const p384: Readonly<import("./_shortw_utils.js").CurveFnWithCreate>;
export declare const secp384r1: Readonly<import("./_shortw_utils.js").CurveFnWithCreate>;
