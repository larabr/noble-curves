...
export declare const p521: Readonly<import("./_shortw_utils.js").CurveFnWithCreate>;
export declare const secp521r1: Readonly<import("./_shortw_utils.js").CurveFnWithCreate>;
